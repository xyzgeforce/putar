...
<html lang="en">
  <head>
    ...
    <link rel="stylesheet" href="http://cdn.jsdelivr.net/npm/chart.js@2.9.4/dist/Chart.min.css" />
    ...
    >
      ...
      >
        ...
        <div class="flex items-center justify-between flex-shrink-0 p-2" :class="{'lg:justify-center': !isSidebarOpen}">
          <span class="p-2 text-xl font-semibold leading-8 tracking-wider uppercase whitespace-nowrap">
            RE<span :class="{'lg:hidden': !isSidebarOpen}">-SPINS</span>
          </span>
        ...
        <nav class="flex-1 overflow-hidden hover:overflow-y-auto">
          ...
          @foreach($scaffold['pages'] as $page)
            <li>
                <a
                  href="{{ $page['slug'] }}"
                ...
                >
                  ...
                  <span :class="{ 'lg:hidden': !isSidebarOpen }">{{ $page['title'] }}</span>
                </a>
              </li>
            @endforeach
            <!-- Sidebar Links... -->
      ...
      <div class="flex flex-col flex-1 h-full overflow-hidden">
        ...
        <main class="flex-1 max-h-full p-5 overflow-hidden overflow-y-scroll">
            ...
            >
            <h1 class="text-2xl font-semibold whitespace-nowrap">{{ $seo['seo_title'] }}</h1>
            <a
      ...
      >
        ...
        <div class="flex-1 bg-white max-h-full p-4 overflow-hidden hover:overflow-y-scroll">
          <span>Settings Content</span>
          <!-- Settings Panel Content ... -->
        </div>
      </div>
    </div>
    <script src="https://raw.githubusercontent.com/Kamona-WD/starter-dashboard-layout/main/public/assets/js/vendor/Chart.bundle.min.js"></script>
    <script src="https://raw.githubusercontent.com/Kamona-WD/starter-dashboard-layout/main/public/assets/js/main.js"></script>
    <script>
      const setup = () => {
        return {
          loading: true,
     ...
     @if(session('message'))
      @include('respins::admin.layout.notifications')
      @endif
